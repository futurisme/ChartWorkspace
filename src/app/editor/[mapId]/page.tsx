...
import { BroadcastRefreshSettings, WORKSPACE_EDIT_ACCESS_CODE } from '@/components/BroadcastRefreshSettings';
...
function EditorContent() {
  ...
  useEffect(() => {
    ...
    setCanEdit(savedAccessCode === WORKSPACE_EDIT_ACCESS_CODE);
