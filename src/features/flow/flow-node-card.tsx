  ...
  return (
    <div className="relative nopan inline-flex flex-col items-start">
      <div className="relative flex w-auto items-start gap-1">
        ...
        <div
          className={`flow-node-drag-handle relative z-20 flex h-[15px] min-h-[15px] max-w-[340px] items-center justify-center cursor-grab touch-none select-none rounded border px-1.5 py-0 shadow-sm active:cursor-grabbing sm:px-2 sm:py-0 ${
            selected
        ...
        >
          ...
          <div
            className="pointer-events-none break-words whitespace-normal text-center text-[9px] font-semibold leading-[1] sm:text-[10px]"
            title={data.label}
          >
            {data.label}
          </div>
